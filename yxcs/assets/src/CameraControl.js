cc.Class({
    ...
    lateUpdate: function (dt) {
        ...
        if (this.smoothFollow) {
           ...
           // cc.log(" this.node.position:" + this.node.position + ",background.position:" + this.Background.position);          
        ...
        if (this.useBoundaries) {
            ...
            {
                this.leftBound = -this.Background.width / 2;
                this.bottomBound = -this.Background.height / 2;
                this.rightBound = this.Background.width / 2;
                this.topBound = this.Background.height / 2;
            }
